...
export class OneDayImpl extends PackageImpl implements OneDay {
    ...
    async calculatePackage(): Promise<object> {
        ...
        const resultObject = { trackingNumber: this.tracking_number, flatFee: OneDayImpl.flat_fee, packageWeight: this.package_weight, costWeight: this.cost_weight, totalCost: totalCost1 }
